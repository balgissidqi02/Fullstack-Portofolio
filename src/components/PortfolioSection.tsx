...
const portfolioItems: PortfolioItemDetail[] = [
  {
    ...
    fullDescription: "Melakukan research calon customer melalui riset online sesuai kriteria, melakukan outreach, memanajemen data seluruh prospek calon pelanggan, serta melakukan follow-up untuk memperbarui status dan informasi pelanggan.",
  ...
  },
  {
    ...
    fullDescription: "Menjalani program magang selama 10 bulan di Slashtech dengan tanggung jawab meliputi content writing, host live, pembuatan content plan, market research, customer outreach, serta optimalisasi customer engagement.",
    role: "Marketing Team",
  ...
  },
  {
    ...
    fullDescription: "Melakukan Pengolahan data melalui proses Analisa menggunakan bahasa pemrograman berbasis Phyton untuk menentukan estimasi harga rumah berdasarkan data dependen yang dimiliki, dengan melalui proses  pembersihan data, eksplorasi data, visualisasi, serta pembuatan model prediktif sederhana.",
    role: "Data Analyst",
  ...
  },
  {
    ...
    fullDescription: "Melakukan pengolahan dan pemodelan data menggunakan Python dengan berbagai rumus, mencakup pembersihan data, analisis, visualisasi dalam bentuk grafik/dashboard, serta penggunaan fitur interaktif seperti filter dan sorting untuk mempermudah eksplorasi data.",
    role: "Data Analyst",
  ...
  },
  {
    ...
    fullDescription: "Aktif sebagai anggota Dewan Ambalan pada tahun 2022–2023 dan 2023–2024, tergabung dalam Divisi Hubungan Masyarakat (Humas). Bertanggung jawab mendukung komunikasi internal dan eksternal, membantu penyebaran informasi kegiatan, serta berkontribusi dalam koordinasi dan publikasi program ambalan. Melalui peran ini, saya mengembangkan kemampuan komunikasi, kerja sama tim, dan tanggung jawab dalam berorganisasi.",
