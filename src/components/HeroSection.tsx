...
const HeroSection = () => {
      ...
      <div className="section-padding container-narrow relative z-10">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-charcoal">FullStack Programmer</span>
          </motion.h1>
  ...
  .
  <br />
  Currently learning to build{" "}
  <span className="text-secondary-foreground font-medium">
    web applications using frontend and backend technologies,
  </span>{" "}
 with a focus on structured coding, problem-solving, and continuously improving technical skills.
</p>
